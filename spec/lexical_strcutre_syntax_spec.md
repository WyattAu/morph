...
- **Floats:** `1.0`, `1e-10`.
- **Optimization Hole:** `??`
  - **Semantics:** Represents a value to be determined by the Compiler's Search Engine.
  - **Usage:** `const UNROLL = ??;`
...
- **Tag:** An optional identifier immediately following the opening fence is treated as a Semantic Hint (e.g., `json`, `sql`) for the Compiler/IDE but ignored at runtime.
