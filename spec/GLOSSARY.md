...
#### Dual Dialects
**Definition:** Morph's two dialects: `min` (canonical, compressed, optimized for storage and LLM generation) and `hum` (projectional, human-readable, generated from `min`).

**Context:** Language Design, Agent-First  
**Related Specifications:** [`spec/language/morph_language_spec.md`](spec/language/morph_language_spec.md)

**See Also:** Projectional Only Mandate, Agent-First, min Dialect, hum Dialect
...
#### hum Dialect
**Definition:** The human-readable dialect of Morph, generated as a projection from the canonical `min` dialect. The `hum` dialect is transient and used for human auditing and understanding.

**Context:** Language Design, Agent-First  
**Related Specifications:** [`spec/language/morph_language_spec.md`](spec/language/morph_language_spec.md)

**See Also:** min Dialect, Dual Dialects, Projectional Only Mandate
...
#### Projection
**Definition:** The process of generating a human-readable representation from a canonical representation. In Morph, the `hum` dialect is a projection of the canonical `min` dialect.

**Context:** Language Design, Agent-First  
**Related Specifications:** [`spec/language/morph_language_spec.md`](spec/language/morph_language_spec.md)

**See Also:** Projectional Only Mandate, Dual Dialects, hum Dialect

---

#### Projectional Only Mandate
**Definition:** The principle that the `min` dialect is the canonical, authoritative representation of Morph code, while the `hum` dialect is a transient projection for human auditing.

**Context:** Language Design, Philosophy  
**Related Specifications:** [`spec/language/morph_language_spec.md`](spec/language/morph_language_spec.md)

**See Also:** Agent-First, Dual Dialects, Projection
...
- **Core Language:** Actor, Agent-First, Async Let, Comptime, Dual Dialects, Flow Construct, hum Dialect, min Dialect, Post-Text Programming Language, Projection, Projectional Only Mandate, Round-Trip Engineering, Scoping, SSUS Pattern, UDF Pattern, Unidirectional Data Flow, Variable Visibility, Visibility Modifier
