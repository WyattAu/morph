...
This module contains concrete examples and test cases for Morph
language specification, demonstrating projectional editing, dual dialects,
and error handling.
...
-- Verify min is canonical 
#eval isCanonicalDialect Dialect.min
-- Expected: true

-- Verify hum is transient 
